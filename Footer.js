        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-4">
              Your AI-powered career companion. Get personalized roadmaps, skill recommendations, 
              and mentorship to accelerate your career growth.
            </p>
            <div className="flex space-x-4">
              ...
              <button className="text-gray-400 hover:text-white transition-colors" aria-label="GitHub">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/roadmaps" className="text-gray-300 hover:text-white transition-colors">
                  Roadmaps
                </Link>
              </li>
              <li>
